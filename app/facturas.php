...
$query=($mysql->query("SELECT DISTINCT grupo FROM ventas WHERE estado='FACTURADA' ORDER BY id ASC"));
$query2=($mysql->query("SELECT * FROM ventas WHERE estado='FACTURADA' ORDER BY id DESC LIMIT 1"));
...
<div class="limiter">
  <div class="container-login1000">
    <div class="wrap-login1000">
		...
		<br>
		<div id="ventas">
			<h2 align="center" style="padding-bottom: 10px;"><span style="color: blue;">FACTURA #<?php echo($factura_nro);?></span></h2>
